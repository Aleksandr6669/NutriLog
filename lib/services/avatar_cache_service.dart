...
class AvatarCacheService {
  ...
  static Future<void> cacheGooglePhoto(String? photoUrl, String uid) async {
    if (photoUrl == null || photoUrl.isEmpty || uid.isEmpty) return;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await prefs.setString('$_cacheKeyPrefix$uid', base64Photo);
      }
    } catch (e) {
