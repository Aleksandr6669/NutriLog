...
- Пользовательское соглашение RU (MD): [docs/agreements/USER_AGREEMENT_ru.md](docs/agreements/USER_AGREEMENT_ru.md)
- User Agreement EN (MD): [docs/agreements/USER_AGREEMENT_en.md](docs/agreements/USER_AGREEMENT_en.md)
- Користувацька угода UK (MD): [docs/agreements/USER_AGREEMENT_uk.md](docs/agreements/USER_AGREEMENT_uk.md)
- Пользовательское соглашение RU (PDF): [docs/agreements/USER_AGREEMENT_ru.pdf](docs/agreements/USER_AGREEMENT_ru.pdf)
- User Agreement EN (PDF): [docs/agreements/USER_AGREEMENT_en.pdf](docs/agreements/USER_AGREEMENT_en.pdf)
- Користувацька угода UK (PDF): [docs/agreements/USER_AGREEMENT_uk.pdf](docs/agreements/USER_AGREEMENT_uk.pdf)
...
### Конфигурация Groq API (Автопереключение токенов)

Приложение поддерживает автоматическое переключение между несколькими GROQ API ключами при исчерпании лимитов запросов.
